...
function StartScreen({ dispatch, numQuestions, selectedChapter }) {
    ...
    return (
      <div className="start">
        ...
        <div className="chapter-buttons">
          ...
          <button className="btn btn-kapitel" onClick={() => dispatch({type: 'selectChapter', payload: 13})}>
            Kapitel 13 - How Cells Obtain Energy From Food
          </button>
          <button className="btn btn-kapitel" onClick={() => dispatch({type: 'selectChapter', payload: 14})}>
            Kapitel 14 - Energy Generation in Mitochondria and Chloroplasts
          </button>
          <button className="btn btn-kapitel" onClick={() => dispatch({type: 'selectChapter', payload: 15})}>
            Kapitel 15 - Intracellular Compartments and Protein Transport
          </button>
          ...
          <button className="btn btn-kapitel" onClick={() => dispatch({type: 'selectChapter', payload: 19})}>
            Kapitel 19 - Sexual Reproduction and The Power Of Genetics
          </button>
          <button className="btn btn-kapitel" onClick={() => dispatch({type: 'selectChapter', payload: 20})}>
            Kapitel 20 - Cell Communities: Tissues, Stem Cells, and Cancer
          </button>
        </div>
      </div>
    );
  ...
  return (
    <div className="start">
      ...
      <h4 style={{color: '#78C841'}}>Rätt svar visas i grönt</h4>
